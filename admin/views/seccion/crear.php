...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="data[seccion]" placeholder="Escribe aquí el nombre" value="<?php if(isset($secciones["seccion"])):echo($secciones['seccion']);endif;?>" id="seccion"/>
        </div>

        <div class="mb-3">
            <label for="area" class="form-label">Área de la sección (m<sup>2</sup>)</label>
            <input class="form-control" id="area" type="number" name="data[area]" placeholder="Escribe aquí el área" value="<?php if(isset($secciones["area"])):echo($secciones['area']);endif;?>"/>
        </div>
